...
```javascript
ddeg2rad = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-ddeg2rad@v0.2.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-ddeg2rad@v0.2.1-umd/browser.js"></script>
```
